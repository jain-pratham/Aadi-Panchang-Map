# How does the sensor calculation work in Aadi Panchang Map?
...
Back in the dawn of time when Aadi Panchang Map was first written this hadn't really been done before
...
long edge of the phone is pointing at. This can be useful if using Aadi Panchang Map with a telescope - 
...
## The end
That's how the calculation is done in Aadi Panchang Map. This is in part for historical reasons: when Sky 
...
inexplicably used a left hand coordinate system for the magnetic field sensor so Aadi Panchang Map was
...
was cleaned up in Aadi Panchang Map in f47d668f9bf8264f6187d0312e6a35c108fa64d6 (after much head-scratching
