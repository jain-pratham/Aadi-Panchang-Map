...
# Aadi Panchang Map Translation Model Comparison
  ...
  **Welsh (cy) — Gemini critically wrong, Haiku and Sonnet correct**
  Gemini translates the app name "Aadi Panchang Map" to "Map Awyr" throughout the entire help document.
  App names are brand identifiers and must not be translated. Both Haiku and Sonnet correctly
  preserve "Aadi Panchang Map". This reverses Gemini's Welsh advantage from Part 1.
  ...
  **Japanese (ja) — Gemini has a literal rendering bug**
  ...
  `<h1>` as "Aadi Panchang Map for Android" rather than the more idiomatic "Android版 Aadi Panchang Map" that
  ...
  **Arabic (ar) and Hindi (hi) — app name translation**
  Both Sonnet and Gemini translate "Aadi Panchang Map" to its literal meaning in Arabic ("خريطة السماء")
  and Hindi ("स्काईमैप"). Haiku keeps "Aadi Panchang Map" as an untranslated brand name, which is the
...
"Aadi Panchang Map" as "Map Awyr". That was fixed by adding an explicit brand-name preservation rule to
