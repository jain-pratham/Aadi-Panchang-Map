package com.aadipanchang.map.gallery
...
class GalleryItemsTest {
    ...
    fun setUp() {
        ...
        `when`(mockContext.packageName).thenReturn("com.aadipanchang.map")
        `when`(mockAssetManager.open("object_info.json"))
            .thenReturn(ByteArrayInputStream(testJson.toByteArray()))

        // Sun string resources
        `when`(mockResources.getIdentifier("sun", "string", "com.aadipanchang.map")).thenReturn(1)
        `when`(mockResources.getIdentifier("object_info_sun_description", "string", "com.aadipanchang.map")).thenReturn(2)
        `when`(mockResources.getIdentifier("object_info_sun_funfact", "string", "com.aadipanchang.map")).thenReturn(3)
        ...
        `when`(mockResources.getIdentifier("mars", "string", "com.aadipanchang.map")).thenReturn(4)
        `when`(mockResources.getIdentifier("object_info_mars_description", "string", "com.aadipanchang.map")).thenReturn(5)
        `when`(mockResources.getIdentifier("object_info_mars_funfact", "string", "com.aadipanchang.map")).thenReturn(6)
        ...
        `when`(mockResources.getIdentifier("m42", "string", "com.aadipanchang.map")).thenReturn(7)
        `when`(mockResources.getIdentifier("object_info_m42_description", "string", "com.aadipanchang.map")).thenReturn(8)
        `when`(mockResources.getIdentifier("object_info_m42_funfact", "string", "com.aadipanchang.map")).thenReturn(9)
