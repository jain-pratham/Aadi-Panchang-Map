...
package com.aadipanchang.map.education
...
class ObjectInfoRegistryTest {
    ...
    fun setUp() {
        ...
        `when`(mockResources.getIdentifier("sun", "string", "com.aadipanchang.map"))
            .thenReturn(1)
        `when`(mockResources.getIdentifier(
            "object_info_sun_description", "string", "com.aadipanchang.map"))
            .thenReturn(2)
        `when`(mockResources.getIdentifier(
            "object_info_sun_funfact", "string", "com.aadipanchang.map"))
            .thenReturn(3)
        `when`(mockResources.getIdentifier(
            "object_info_sun_distance", "string", "com.aadipanchang.map"))
            .thenReturn(10)
        `when`(mockResources.getIdentifier(
            "object_info_sun_size", "string", "com.aadipanchang.map"))
            .thenReturn(11)
        `when`(mockResources.getIdentifier(
            "object_info_sun_mass", "string", "com.aadipanchang.map"))
            .thenReturn(12)

        // Mock string resources for Mars
        `when`(mockResources.getIdentifier("mars", "string", "com.aadipanchang.map"))
            .thenReturn(4)
        `when`(mockResources.getIdentifier(
            "object_info_mars_description", "string", "com.aadipanchang.map"))
            .thenReturn(5)
        `when`(mockResources.getIdentifier(
            "object_info_mars_funfact", "string", "com.aadipanchang.map"))
            .thenReturn(6)
        `when`(mockResources.getIdentifier(
            "object_info_mars_distance", "string", "com.aadipanchang.map"))
            .thenReturn(13)
        `when`(mockResources.getIdentifier(
            "object_info_mars_size", "string", "com.aadipanchang.map"))
            .thenReturn(14)
        `when`(mockResources.getIdentifier(
            "object_info_mars_mass", "string", "com.aadipanchang.map"))
            .thenReturn(15)

        // Mock string resources for M42
        `when`(mockResources.getIdentifier("m42", "string", "com.aadipanchang.map"))
            .thenReturn(7)
        `when`(mockResources.getIdentifier(
            "object_info_m42_description", "string", "com.aadipanchang.map"))
            .thenReturn(8)
        `when`(mockResources.getIdentifier(
            "object_info_m42_funfact", "string", "com.aadipanchang.map"))
            .thenReturn(9)
