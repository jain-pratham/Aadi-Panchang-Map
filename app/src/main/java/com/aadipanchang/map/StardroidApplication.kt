...
import com.aadipanchang.map.util.MiscUtil.getTag
import com.aadipanchang.map.util.PreferenceChangeAnalyticsTracker
...
open class StardroidApplication : Application() {
  ...
  override fun attachBaseContext(base: android.content.Context) {
    ...
    val isHindi = prefs.getBoolean("nakshatra_language_hindi", false)
  ...
  override fun onCreate() {
    ...
    Log.i(TAG, "Aadi Panchang Map version $versionName build $version")
  ...
  /**
   * Returns the version string for Aadi Panchang Map.
   */
  ...
  /**
   * Returns the build number for Aadi Panchang Map.
   */
  val version: Long
    get() {
      val packageManager = packageManager
