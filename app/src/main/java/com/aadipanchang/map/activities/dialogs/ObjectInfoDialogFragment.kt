...
import com.aadipanchang.map.activities.dialogs.ObjectInfoDialogFragment.Companion.newInstance
...
class ObjectInfoDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        view.findViewById<ImageButton>(R.id.object_info_close_button).setOnClickListener {
            dismiss()
        }
