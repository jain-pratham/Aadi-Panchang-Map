...
import com.aadipanchang.map.touch.DragRotateZoomGestureDetector.DragRotateZoomGestureDetectorListener
...
class MapMover @Inject constructor(
  ...
  override fun onGestureEnd() {
    // Temporarily disabled horizon leveling to eliminate camera drift after drag
